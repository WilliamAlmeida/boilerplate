<div>
    <!-- HEADER -->
    <x-header title="Funções" separator progress-indicator>
    ...
    <!-- TABLE  -->
    <x-card>
        <x-table :headers="$headers" :rows="$roles" :sort-by="$sortBy" with-pagination wire:model="selected" selectable per-page="perPage" :per-page-values="[20, 50, 100]">
    ...
    <x-drawer wire:model="drawer" title="Filtros" right separator with-close-button class="lg:w-1/3">
        <div class="flex flex-col space-y-4">
            ...
            <x-select 
                ...
                wire:model.live.debounce.250ms="permission_id" 
                :options="$permissions" 
    ...
    <livewire:admin.roles.role-edit />
</div>