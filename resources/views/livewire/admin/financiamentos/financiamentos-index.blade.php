<div>
    <!-- HEADER -->
    <x-header title="Financiamentos" separator progress-indicator>
    ...
    <!-- TABLE  -->
    <x-card>
        <x-table :headers="$headers" :rows="$financiamentos" :sort-by="$sortBy" with-pagination per-page="perPage" :per-page-values="[20, 50, 100]">
    ...
    <x-drawer wire:model="drawer" title="Filtros" right separator with-close-button class="lg:w-1/3">
        <div class="flex flex-col space-y-2">
            ...
            <div class="grid grid-cols-2 gap-4">
                <x-input label="Banco/Perfil" wire:model="filter.banco_perfil" clearable />
                <x-input label="Status" wire:model="filter.status" clearable />
            </div>
            ...
            <div class="flex flex-col">
                <x-mary.label label="Data" class="font-semibold" />
                <div class="grid grid-cols-2 gap-4">
