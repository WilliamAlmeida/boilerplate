<div>
    <!-- DRAWER -->
    <x-drawer wire:model="showDrawer" title="Novo Financiamento" subtitle="Cadastrar novo financiamento" separator with-close-button close-on-escape right
        ...
        <x-tabs wire:model="selectedTab">
            <x-tab name="info-tab" label="Informações Básicas" icon="o-document-text">
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <x-input label="Valor PMT (R$)" wire:model="form.pmt" icon="o-currency-dollar" type="number" step="0.01" min="0" />
                        <x-input label="Valor Financiado (R$)" wire:model="form.financiado" icon="o-currency-dollar" type="number" step="0.01" min="0" />
                        <x-input label="Produção (R$)" wire:model="form.producao" icon="o-currency-dollar" type="number" step="0.01" min="0" />
                    </div>
                </div>
            </x-tab>
