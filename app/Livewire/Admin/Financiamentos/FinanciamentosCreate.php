...
class FinanciamentosCreate extends Component
{
    use Toast;
    ...
    public function save()
    {
        ...
        try {
            Financiamentos::create($this->form->all());

            $this->form->reset();
            $this->showDrawer = false;
            $this->success('Financiamento cadastrado com sucesso.', position: 'toast-bottom');
            ...
            $this->error('Erro ao cadastrar financiamento.', position: 'toast-bottom');
        }
    }
    ...
    {
        return view('livewire.admin.financiamentos.financiamentos-create');
    }
}
